...
local function handler(input)
    ...
    if op ~= "implement_graph" and op ~= "integrate" and op ~= "finish" then
        return nil, "operation must be: implement_graph, integrate, or finish"
    end
    ...
    if op == "implement_graph" then
        if not input.implementation_plan then
            return nil, "implementation_plan required for implement_graph operation"
        end
