...
local function render_msg_body(msg, opts)
    ...
    if opts and opts.preview then
        return render.clip(text, math.floor(tonumber(opts.preview_chars) or 240))
    end
    return render.clip(text, math.floor(tonumber(opts and opts.full_chars) or 1200))
end
