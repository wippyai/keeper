...
local SEED_DATA = {
    {
        ...
        source = "seed",
        confidence = 1.0,
        refs = { "keeper.usage.api:get_summary", "keeper.usage.api:get_summary.endpoint" },
    },
    {
        node_type = "pattern",
    ...
    },
    {
        ...
        content = "Entry IDs follow `namespace:name` format.\n- Namespace: dot-separated hierarchy (e.g. `keeper.usage.api`)\n- Name: snake_case identifier\n- Endpoint entries append `.endpoint` suffix\n- Test entries use `test` as name\n\nExamples: `keeper.usage.api:get_summary`, `keeper.usage.api:get_summary.endpoint`",
        source = "seed",
        confidence = 1.0,
    },
    {
