    ...
    describe("Knowledge Changelog", function()
        ...
        describe("stats", function()
            it("returns aggregate counts", function()
                ...
                test.is_nil(err)
                if not stats then error("expected changelog stats") end
                local stats_any = stats :: any
                test.is_true(stats_any.total >= 3)
                test.is_true(stats_any.versions >= 1)
                test.is_true(stats_any.namespaces >= 1)
                test.not_nil(stats_any.first_change)
                test.not_nil(stats_any.last_change)
            end)
        end)
    end)
end
