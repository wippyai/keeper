...
<template>
  <div>
    ...
    <div v-if="dataflowId" class="mb-2 text-[10px]">
      <button class="font-mono flex items-center gap-1" style="color: var(--p-primary)" @click.stop="router.push('/dataflow/' + dataflowId)">
    ...
    <button v-if="(resultData?.length || 0) > 500" class="text-[11px] mt-1.5 flex items-center gap-1" style="color: var(--p-primary)" @click="expanded = !expanded">
